...
int main()
{
    ...
    if (specific_true)
    {
        ...
        for (int x = 0; x < 3; ++x)
        {
            r[x] = specific[0] * cell_vec[0][x] + specific[1] * cell_vec[1][x] + specific[2] * cell_vec[2][x] +
                   (positions[specific[3]][x] - positions[central_atom][x]);
        }
        ...
        err = false;
        calc_exchange(central_atom, specific, num_orb, num_kpoints, ntot, spin, cell_vec, k_vec, E, dE, Ham_K, mag_orbs, exchange, err);
