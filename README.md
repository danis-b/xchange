...
where $m, m^{\prime},  n, n^{\prime}$ are orbital quantum numbers, $S$ is the spin quantum number, and $\Delta^{m m^{\prime}}_i$ is the on-site potential. In turn, the Green's function is defined as $G(\epsilon) = 1/(\epsilon - H) $
